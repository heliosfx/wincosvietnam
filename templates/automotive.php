...
get_header();
?>
<main class="page-wrapper main static-page" id="automotive-page">
    <section class="automotive-section1 pb-10" style="background: url(<?php echo THEME_ASSET_URL ?>images/automotive/automotive-img1.jpg), #000 -110.267px 0px / 111.486% 100% no-repeat">
        ...
        <div class="d-flex">
            <div class="container d-flex flex-wrap">
                <div class="section-header">
                    <div class="section-des des-title text-white text-justify">
                        <p>Phim cách nhiệt ô tô hiệu suất cao đem đến trải nghiệm lái xe tuyệt vời.</p>
                        <p>Nâng cấp không gian xe nhưng vẫn giữ vững thiết kế ban đầu.</p>
                        <p>Cảm nhận sự thoải mái khi giảm bớt gánh nặng năng lượng lên xe và môi trường.</p>
                        <p>Chất lượng cao cấp trong từng lớp phim Wincos ảnh hưởng trực tiếp đến các giác quan của bạn khi lái xe.</p>
                    </div>
                </div>
                <div class="mt-auto">
                                ...
                                <div class="item">
                                    ...
                                    <div class="item-details mt-3">
                                        ...
                                        <div class="item-content text-justify text-white">
                                            <p>Giảm kích ứng da do nắng gắt. Ngăn chặn gia tăng nhiệt độ bên trong xe và cắt giảm hơn 99% tia UV gây cháy nắng và tàn nhang.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="automotive-section2 d-flex align-items-center" style="background: url(<?php echo THEME_ASSET_URL ?>images/automotive/automotive-img2.jpg), lightgray -204.168px 0px / 121.268% 100% no-repeat">
    ...
    <section class="automotive-section3 pb-10" style="background: linear-gradient(180deg, #000 0%, rgba(32, 32, 32, 0.95) 48.39%, rgba(47, 47, 47, 0.85) 77.08%, rgba(98, 98, 98, 0.85) 100%)">
        <div class="container">
                        ...
                        <div class="automotive-item h-100">
                            ...
                            <div class="automotive-details">
                                ...
                                <div class="automotive-content text-justify">
                                    <p>Ngăn chặn sức nóng từ ánh nắng mặt trời vào mùa hè và giảm cảm giác nóng ran trên da, góp phần ngăn chặn sự gia tăng nhiệt độ bên trong xe và tạo không gian xe thoải mái.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-4 mt-md-10 mt-5">
                        <div class="automotive-item h-100">
                            ...
                            <div class="automotive-details">
                                ...
                                <div class="automotive-content text-justify">
                                    <p>Phim dán Wincos cam kết cắt giảm hơn 99% tia UV có hại cho cơ thể con người, an toàn cho phụ nữ và trẻ nhỏ có làn da nhạy cảm.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-4 mt-md-10 mt-5">
                        <div class="automotive-item h-100">
                            ...
                            <div class="automotive-details">
                                ...
                                <div class="automotive-content text-justify">
                                    <p>Phim dán Wincos có lớp sơn cứng có khả năng chống mài mòn cao được phủ lên bề mặt của phim để giảm hư hại cho bề mặt phim trong quá trình thi công và vệ sinh.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-4 mt-md-10 mt-5">
                        <div class="automotive-item h-100">
                            ...
                            <div class="automotive-details">
                                ...
                                <div class="automotive-content text-justify">
                                    <p>Loại tối giúp che tầm nhìn từ bên ngoài xe, đồng thời mang lại tầm nhìn rõ và tốt từ bên trong xe.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-4 mt-md-10 mt-5">
                        <div class="automotive-item h-100">
                            ...
                            <div class="automotive-details">
                                ...
                                <div class="automotive-content text-justify">
                                    <p>Bằng cách sử dụng màng nhuộm gốc, phim Wincos đạt được cả độ trong suốt và độ bền cao, rất ít phai màu và có thể duy trì mật độ màu trong thời gian dài.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="section-header d-flex align-items-center justify-content-between b-t pt-10 mb-10 flex-wrap">
                <div class="section-header-col text-white">
                        ...
                        <figure class="automotive-media p-relative">
                            ...
                            <div class="automotive-details p-absolute">
                                ...
                                <div class="automotive-meta mt-auto">
                                    <div class="meta1 font-weight-bold">TỐI ĐA</div>
                                    <div class="number font-weight-bold mb-2">97<span class="font-weight-normal">%</span></div>
                                    <div class="subtitle">Cản tia hồng ngoại (IR - Infrared)</div>
                                </div>
                            </div>
                        </figure>
                    ...
                    <div class="automotive-item1 text-white">
                        <figure class="automotive-media p-relative">
                            ...
                            <div class="automotive-details p-absolute">
                                ...
                                <div class="automotive-meta mt-auto">
                                    <div class="meta1 font-weight-bold">TỐI ĐA</div>
                                    <div class="number font-weight-bold mb-2">62<span class="font-weight-normal">%</span></div>
                                    <div class="subtitle">Cản tia hồng ngoại (IR - Infrared)</div>
                                </div>
                            </div>
                        </figure>
                        <div class="automotive-content text-white mt-3">
                            <p>Phim cách nhiệt tiêu chuẩn cần thiết dành cho xe ô tô, 1 sự kết hợp hoàn hảo giữa thiết kế và chúc năng, với 1 loạt các ứng dụng thông số khác nhau</p>
                        </div>
                    </div>
                </div>
            </div>
