        ...
        <div class="section-wrapper pt-10 pb-10">
            ...
            <div class="section-body mt-2">
                <div class="section-content mb-5 mb-md-10 des-title text-justify" style="letter-spacing: 1.28px">
                    <p>Chúng tôi nâng cao giá trị của không gian bằng công nghệ cao và phim chức năng.Tại Wincos, chúng tôi theo sát các yêu cầu thông qua một hệ thống cộng tác trơn tru giúp kết nối khách hàng và địa điểm sản xuất, đồng thời phản hồi một cách tỉ mỉ.Chúng tôi tùy chỉnh các chức năng và đề xuất loại phim tối ưu.</p>
                </div>
                <div class="section-btn">
                    <a class="btn btn-white btn-outline text-normal btn-ellipse" href="<?=home_url('architecture') ?>/" title="Phim cách nhiệt cho công trình">Thông tin chi tiết</a>
                </div>
            </div>
        </div>
    </div>
