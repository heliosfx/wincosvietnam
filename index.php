...
<main class="page-wrapper main home" id="index-page">
    <section class="index-section1 d-flex section-border-radius" style="background-image: url(<?php echo THEME_ASSET_URL ?>images/default/index-img1.jpg)">
        <div class="container text-white h-auto d-flex flex-wrap">
            ...
            <div class="section-des des-title font-weight-bold w-100 mt-auto h5 text-white">
                <p>Wincos “thiết kế tiện nghi” ở Nhật Bản và toàn thế giới.</p>
            </div>
        </div>
    </section>

    <div class="section-border-radius-next">
        ...
        <div class="section-item row ">
            ...
            <div class="col-md-6 section-details d-flex align-items-center">
                <div class="section-wrapper">
                    ...
                    <h2 class="section-title text-primary w-100 font-weight-semibold">
                        CÔNG NGHỆ<br /> WINCOS
                    </h2>
                    <div class="section-content des-title text-justify">
