...
<main class="page-wrapper main home" id="index-page">
    <section class="index-section1 d-flex section-border-radius" style="background-image: url(<?php echo THEME_ASSET_URL ?>images/default/index-img1.jpg)">
    ...
    <section class="index-section4 container">
        <div class="section-item row mb-5 mb-md-10">
            <figure class="col-md-6 section-media">
                <img class="w-100" src="<?php echo THEME_ASSET_URL ?>images/default/index-img4.jpg" alt="Công nghệ Wincos" width="585" height="696" loading="lazy" />
            </figure>
        ...
        <div class="section-item row mb-5 mb-md-10">
            <figure class="col-md-6 section-media">
                <img class="w-100" src="<?php echo THEME_ASSET_URL ?>images/default/index-img5.jpg" alt="Thiết kế sự tiện nghi" width="585" height="696" loading="lazy" />
            </figure>
            <div class="col-md-6 section-details d-flex align-items-center">
                <div class="section-wrapper">
                    ...
                    <div class="section-content mb-5 des-title text-justify">
                        <p>Wincos đã có hơn 40 năm kinh nghiệm với tư cách là đối<br/> tác sản xuất phim cách nhiệt.<br/> Đằng sau sự phát triển của phim là mong muốn đóng góp<br/> cho toàn xã hội bằng cách mang lại sự an tâm và yên bình.</p>
                    </div>
    ...
    <section class="index-section5 container mb-5" id="blog">
        <div class="section-header d-flex align-items-center justify-content-between mb-5">
            ...
            <div class="section-btn"><a href="/blog/" class="btn btn-primary text-normal btn-ellipse font-weight-normal"><?php _e('Đọc thêm') ?></a></div>
        </div>
        <div class="section-body row gutter-xl cols-lg-4 cols-2">
